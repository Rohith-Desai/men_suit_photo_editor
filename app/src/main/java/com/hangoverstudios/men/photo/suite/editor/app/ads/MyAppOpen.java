...
import com.hangoverstudios.men.photo.suite.editor.app.model.CustomModel;
...
public class MyAppOpen extends Application implements ActivityLifecycleCallbacks, LifecycleObserver {
    ...
    private static final String ONESIGNAL_APP_ID = "7876cb7f-0b8a-4662-9b61-3526a1503ec5";
    ...
    protected void onMoveToForeground() {
        ...
        if (CustomModel.getInstance().canDisplayAppOpen())
