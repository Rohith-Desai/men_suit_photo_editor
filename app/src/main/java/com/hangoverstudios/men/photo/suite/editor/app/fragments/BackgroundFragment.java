...
public class BackgroundFragment extends Fragment implements StoriesProgressView.StoriesListener {
    private final int[] resources = new int[]{
            R.drawable.sbackground_1,
            R.drawable.sbackground_2,
            R.drawable.sbackground_3,
