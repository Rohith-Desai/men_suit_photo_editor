...
public class FramesFragment  extends Fragment implements StoriesProgressView.StoriesListener {
    private final int[] resources = new int[]{
            R.drawable.sframes_1,
            R.drawable.sframes_2,
            R.drawable.sframes_3,
        ...
        Trynow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (CommonMethods.getInstance().getCallimageSelection()!=null){
                    ...
                    CommonMethods.getInstance().setFromDemo("fromFrames");
                }
            }
        });
       ...
       /* final Handler handler = new Handler(Looper.getMainLooper());
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                CommonMethods.getInstance().getCategorystatuschange().changeState(5);
            }
        }, 100);*/
    }
