...
public class AccessoriesFragment extends Fragment implements StoriesProgressView.StoriesListener {
    private final int[] resources = new int[]{
            R.drawable.sblendeffect_1,
            R.drawable.sblendeffect_2,
            R.drawable.sblendeffect_3,
...
//                    CommonMethods.getInstance().setFromDemo("fromAccess");
                }
            }
        });
