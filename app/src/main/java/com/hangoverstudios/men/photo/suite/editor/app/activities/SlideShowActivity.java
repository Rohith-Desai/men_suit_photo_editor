...
import static com.hangoverstudios.men.photo.suite.editor.app.activities.GalleryActivity.subFolderName1;
...
public class SlideShowActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(galleryActivity!=null){
            imgPaths = galleryActivity.getImagesFromDevice(subFolderName1);
    ...
    public void shareImage() {
        ...
        for (int i = 0; i < deleteFile.size(); i++) {
            ...
            Uri uri = FileProvider.getUriForFile(SlideShowActivity.this, BuildConfig.APPLICATION_ID + ".provider", new File(deleteFile.get(i)));
            files.add(uri);
        }
        Intent shareIntent;
