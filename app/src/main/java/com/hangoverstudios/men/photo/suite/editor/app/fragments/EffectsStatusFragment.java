...
public class EffectsStatusFragment extends Fragment implements StoriesProgressView.StoriesListener {
    private final int[] resources = new int[]{
            R.drawable.seffects_1,
            R.drawable.seffects_2,
            R.drawable.seffects_3,
        ...
        Trynow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (CommonMethods.getInstance().getCallimageSelection()!=null){
                    ...
                    CommonMethods.getInstance().setFromDemo("fromEffects");
                }
            }
        });
