...
public class MirrorImageMode {
    ...
    public MirrorImageMode(int count, RectF sR, RectF rect1, RectF rect2, Matrix matrix, int tM, RectF rta) {
        this.count = count;
        this.srcRect = sR;
    ...
    public MirrorImageMode(int c, RectF sR, RectF r1, RectF r2, RectF r3, RectF r4, Matrix m1, Matrix m2, Matrix m3, int tM, RectF rta) {
        this.count = c;
        this.srcRect = sR;
        this.drawBitmapSrc = new Rect();
