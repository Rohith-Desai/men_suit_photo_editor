...
public class MakeoverFragment extends Fragment implements StoriesProgressView.StoriesListener {

    private final int[] resources = new int[]{
           // R.drawable.sphotocollage_1,
           // R.drawable.sphotocollage_2,
           // R.drawable.sphotocollage_3,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_makeover, container, false);
        Trynow =view.findViewById(R.id.trynowbutton);
        Trynow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                getActivity().onBackPressed();
                if (CommonMethods.getInstance().getPhotocollageopen()!=null){
                    CommonMethods.getInstance().getPhotocollageopen().OpenphotocollageListiner();
                    CommonMethods.getInstance().setFromDemo("fromMakeOver");
                }
            }
        });
